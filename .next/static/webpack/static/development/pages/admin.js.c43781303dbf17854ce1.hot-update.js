...
var getBlogsDateData = function getBlogsDateData(token, month_) {
  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_0___default()("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["API"], "/admin/data/blogs/:month_"), {
    method: 'GET',
    headers: {
      Accept: 'application/json',
      Authorization: "Bearer ".concat(token)
...
//# sourceMappingURL=admin.js.c43781303dbf17854ce1.hot-update.js.map