...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    Object(_actions_admin__WEBPACK_IMPORTED_MODULE_3__["getBlogsDateData"])(token).then(function (res) {
      ...
      console.log(res.data.filter(function (_ref) {
        var month = _ref._id.month;
        return month === month_;
      }));
      setData(res.data);
      setChartDataThisMonth({
        date: res.data.filter(function (_ref2) {
          var month = _ref2._id.month;
          return month === month_;
        }).sort(function (a, b) {
        ...
        data: res.data.filter(function (_ref4) {
          var month = _ref4._id.month;
          return month === month_;
        }).sort(function (a, b) {
      ...
      setChartDataThisYear({
        date: res.data.sort(function (a, b) {
          ...
          var _ref6$_id = _ref6._id,
              year = _ref6$_id.year,
              month = _ref6$_id.month,
              day = _ref6$_id.day;
          return moment__WEBPACK_IMPORTED_MODULE_13___default()("".concat(year, "-").concat(month, "-").concat(day, "T00:00:00")).format('MMMM');
        }),
      ...
      setSelectedChartData({
        date: res.data.sort(function (a, b) {
          ...
          var _ref8$_id = _ref8._id,
              year = _ref8$_id.year,
              month = _ref8$_id.month,
              day = _ref8$_id.day;
          return moment__WEBPACK_IMPORTED_MODULE_13___default()("".concat(year, "-").concat(month, "-").concat(day, "T00:00:00")).format('dddd');
        }),
        data: res.data.sort(function (a, b) {
...
//# sourceMappingURL=admin.js.d058539a03ca30c62e70.hot-update.js.map