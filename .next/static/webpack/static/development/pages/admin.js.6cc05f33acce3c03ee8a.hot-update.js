...
var getBlogsDateData = function getBlogsDateData(token, month_, year) {
  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_0___default()("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["API"], "/admin/data/blogs/").concat(month_, "/2019"), {
    method: 'GET',
    headers: {
      Accept: 'application/json',
      Authorization: "Bearer ".concat(token)
...
//# sourceMappingURL=admin.js.6cc05f33acce3c03ee8a.hot-update.js.map