...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    Object(_actions_category__WEBPACK_IMPORTED_MODULE_4__["getCategories"])().then(function (catagories) {
      if (catagories.error) {
      ...
      if (catagories) {
        Object(_actions_admin__WEBPACK_IMPORTED_MODULE_5__["getCategoriesData"])(token, month_, year_).then(function (res) {
          if (res.error) {
            console.log(res.error);
          } else {
            var result = [res, catagories].reduce(function (a, b) {
...
//# sourceMappingURL=admin.js.bf9783f86ebcd6e96659.hot-update.js.map