      ...
      setChartDataThisMonth({
        date: res.data.sort(function (a, b) {
          ...
          var _ref$_id = _ref._id,
              ...
              day = _ref$_id.day;
          return moment__WEBPACK_IMPORTED_MODULE_5___default()("".concat(year, "-").concat(month, "-").concat(day, "T00:00:00")).format('dddd');
        }),
      ...
      setChartDataThisYear({
        date: res.data.sort(function (a, b) {
          ...
          var _ref3$_id = _ref3._id,
              ...
              day = _ref3$_id.day;
          return moment__WEBPACK_IMPORTED_MODULE_5___default()("".concat(year, "-").concat(month, "-").concat(day, "T00:00:00")).format('mmmm');
        }),
        data: res.data.sort(function (a, b) {
          return a._id.day > b.last_nom ? 1 : b._id.day > a._id.day ? -1 : 0;
...
//# sourceMappingURL=admin.js.3cf0839338e13a84d42a.hot-update.js.map