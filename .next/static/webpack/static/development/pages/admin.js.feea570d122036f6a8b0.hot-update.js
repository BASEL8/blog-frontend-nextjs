...
var getBlogsDateData = function getBlogsDateData(token, month_, year_) {
  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_0___default()("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["API"], "/admin/data/blogs/").concat(month_, "/").concat(year_), {
    method: 'GET',
    headers: {
      Accept: 'application/json',
      Authorization: "Bearer ".concat(token)
...
var getTagsData = function getTagsData(token, month_, year_) {
  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_0___default()("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["API"], "/admin/data/tags/").concat(month_, "/").concat(year_), {
    method: 'GET',
    headers: {
      Accept: 'application/json',
      Authorization: "Bearer ".concat(token)
...
var getCategoriesData = function getCategoriesData(token, month_, year_) {
  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_0___default()("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["API"], "/admin/data/categories/").concat(month_, "/").concat(year_), {
    method: 'GET',
    headers: {
      Accept: 'application/json',
      Authorization: "Bearer ".concat(token)
...
//# sourceMappingURL=admin.js.feea570d122036f6a8b0.hot-update.js.map